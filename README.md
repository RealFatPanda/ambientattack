...
## Download Wav2Vec2.0
- Please visit this website https://github.com/facebookresearch/fairseq/tree/main/examples/wav2vec
- Download the checkpoint Wav2Vec 2.0 Base
- dict.ltr.txt file: https://dl.fbaipublicfiles.com/fairseq/wav2vec/dict.ltr.txt

## Download NISQA
- Please visit this website https://github.com/gabrielmittag/NISQA
...
- Run the second step Ambient Sound Perceptual Optimization
- You can directly use the test sample in the folder data_test
```
